...
namespace Misc{
	...
	const char* Msg(int iOpt){
		...
		switch(iOpt){
			...
			case 101:
				return "subir,Sube un archivo local al cliente,-l /archivo/local,-r /remoto/archivo";
			case 102:
			...
			case 104:
				return "subir,Sube un archivo local al cliente,-l /local/archivo,-r C:\\remoto\\archivo";
			case 105:
			...
			case 108:
				return "subir,Sube un archivo a todos los clientes,-l /local/archivo, -r si|no (Ejecutar),-o windows|linux|*";
			case 109:
		...
		switch(iOpt){
			...
			case 101:
				return "upload,Upload a localfile to client,-l /local/file,-r /remote/path";
			case 102:
			...
			case 104:
				return "upload,Upload a local file to client,-l /local/file,-r C:\\remote\\file";
			case 105:
			...
			case 108:
				return "upload,Upload a file to all clients,-l /local/file, -r yes|no (Exec),-o windows|linux|*";
			case 109:
